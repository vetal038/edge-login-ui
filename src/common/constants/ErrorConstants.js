...
export const PASSWORD_REQUIRED_ERROR = 'Password field is required'
export const CONFIRM_PASSWORD_REQUIRED_ERROR = 'Confirm password field is required'
export const USERNAME_3_CHARACTERS_ERROR = 'Minimum 3 characters'
export const USERNAME_ASCII_ERROR = 'Must only be ascii characters'
export const USERNAME_EXISTS_ERROR = 'Username already exists'
export const USERNAME_REQUIRED_ERROR = 'Username field is required'
