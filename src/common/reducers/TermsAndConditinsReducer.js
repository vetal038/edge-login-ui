...
const titleOne =
  'I understand that my funds are held securely on this device, not by vCASH'
const titleTwo =
...
const titleThree =
  'I understand that if I lose my username and password, vCASH will not be able to recover my account, unless I setup password recovery'
const initialState = {
  items: [
